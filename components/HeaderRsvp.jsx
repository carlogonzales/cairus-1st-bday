...
const HeaderRsvp = () => {
  return (
    <header className="relative mx-auto max-w-5xl px-4 pt-6 sm:px-6">
      <div
        className="flex items-center justify-between gap-3 fixed bottom-0 left-0 right-0 z-[100] bg-[#78350F] px-2 py-2 pr-8 lg:static lg:justify-end lg:bg-transparent lg:px-0 lg:py-0">
        <div className="flex items-center gap-2"></div>
        <a href="#rsvp"
           className="rounded-full bg-[#FFCB40] px-4 py-2 text-sm font-semibold text-[#78350F] shadow-lg hover:bg-[#E6B83A]">
          RSVP Now
        </a>
      </div>
